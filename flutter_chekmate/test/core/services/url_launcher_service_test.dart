  ...
  group(
    ...
    () {
      ...
      group('Maps Validation', () {
        ...
        test('openMapsWithAddress throws exception for empty address',
            () async {
          expect(
    ...
    skip:
        'Requires platform plugin (url_launcher) - UrlLauncherService methods access native platform channels',
  );
}
