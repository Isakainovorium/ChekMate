  ...
  group(
    ...
    () {
      ...
      group('requestVideoCallPermissions', () {
        test('returns true when both microphone and camera are granted',
            () async {
          expect(permissionService, isNotNull);
        });
        ...
        test('opens settings when either permission is permanently denied',
            () async {
          expect(permissionService, isNotNull);
        });
      });
      ...
      group('checkPermission', () {
        ...
        test('sets shouldOpenSettings to true when permanently denied',
            () async {
          expect(permissionService, isNotNull);
        });

        test('sets shouldOpenSettings to false when not permanently denied',
            () async {
          expect(permissionService, isNotNull);
        });
      });
    ...
    skip:
        'Requires platform plugin (permission_handler) - PermissionService methods access native platform channels',
  );
}
