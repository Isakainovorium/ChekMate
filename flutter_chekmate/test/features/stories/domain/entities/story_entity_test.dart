...
void main() {
  group('StoryEntity', () {
    ...
    group('Equality', () {
      test('two stories with same properties are equal', () {
        final story1 = testStory;
        final story2 = StoryEntity(
          id: testStory.id,
          userId: testStory.userId,
          username: testStory.username,
          userAvatar: testStory.userAvatar,
          type: testStory.type,
          url: testStory.url,
          createdAt: testStory.createdAt,
          expiresAt: testStory.expiresAt,
          views: testStory.views,
          likes: testStory.likes,
          isViewed: testStory.isViewed,
        );
        expect(story1, equals(story2));
      });

      test('two stories with different properties are not equal', () {
        final story1 = testStory;
  ...
  group('StoryUserEntity', () {
    ...
    group('Business Logic Methods', () {
      ...
      test('allViewed returns true when all stories are viewed', () {
        final allViewedStories =
            testStories.map((s) => s.copyWith(isViewed: true)).toList();
    ...
    group('Equality', () {
      test('two story users with same properties are equal', () {
        final user1 = testStoryUser;
        final user2 = StoryUserEntity(
          userId: testStoryUser.userId,
          username: testStoryUser.username,
          userAvatar: testStoryUser.userAvatar,
          stories: testStoryUser.stories,
          isOwn: testStoryUser.isOwn,
          isFollowing: testStoryUser.isFollowing,
        );
        expect(user1, equals(user2));
      });

      test('two story users with different properties are not equal', () {
        final user1 = testStoryUser;
