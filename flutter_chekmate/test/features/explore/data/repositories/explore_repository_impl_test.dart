...
void main() {
  group('ExploreRepositoryImpl', () {
    ...
    group('Input Validation', () {
      test('getContentByHashtag throws exception for empty hashtag', () async {
        expect(
      ...
      test('getContentByCategory throws exception for empty category', () async {
        expect(
      ...
      test('getTrendingContent throws exception for negative limit', () async {
        expect(
      ...
      test('getTrendingHashtags throws exception for negative limit', () async {
        expect(
