...
class AppConstants {
  ...
  static const String appDescription =
      ...
      'Share your date stories, rate your experiences, and discover what others are saying about their dating adventures. '
  ...
  // Rating Settings - Core Feature for Dating Experience Platform
  static const List<String> ratingOptions = ['WOW', 'GTFOH', 'ChekMate'];
  static const Map<String, String> ratingDescriptions = {
    'WOW': 'That\'s Amazing; Sweet!',
    'GTFOH': 'NOT RECOMMENDED',
    'ChekMate':
        'Smart Play - user handled the situation right, outsmarting their date',
  };
